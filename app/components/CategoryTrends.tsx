  ...
  return (
    <div className="bg-surface rounded-2xl border border-line p-8 shadow-2xl space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-bold text-ink tracking-tight">Top Catégories du Semestre</h2>
            ...
            <div key={cat.name} className="space-y-1.5">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-semibold text-body">{cat.name}</span>
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-xs font-mono text-body-soft">{formatCUR(cat.total)}</span>
                  {cat.trendPct === null ? (
